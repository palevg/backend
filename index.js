...
app.patch('/peoples/editfounder', checkAuth, PersonController.updatePersonFounders);
app.patch('/peoples/edithead', checkAuth, PersonController.updatePersonHeads);
app.post('/peoples/newfounder', checkAuth, PersonController.insertPersonFounders);
