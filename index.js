...
app.patch('/order/new', checkAuth, FirmaController.insertNewOrder);
...
app.get('/checks/:id', checkAuth, FirmaController.getChecks);
app.patch('/check/new', checkAuth, FirmaController.insertNewCheck);
app.patch('/check/edit', checkAuth, FirmaController.updateCheck);
