...
app.post('/peoples/newfounder', checkAuth, PersonController.insertPersonFounder);
app.post('/peoples/newhead', checkAuth, PersonController.insertPersonHead);
...
app.patch('/peoples/editfounder', checkAuth, PersonController.updatePersonFounder);
